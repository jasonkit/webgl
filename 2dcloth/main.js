...
function main()
{
    ...
    var cloth = new Cloth(300,200,64,webgl);
    
    var animation = new Animation();
    animation.step = function(interval) {
        var niter = 20;
        for (var i=0; i<niter; i++){
            cloth.update(Math.min(interval/(niter*1000.0),0.017));
        }
        cloth.render(); 
    ...
    cloth.init(function(){
        ...
        //cloth.update();
        //cloth.render();
        //show_memory(dbgbuf, this.grid.width, this.grid.height, 4);
...
function init()
{
    ikd.load(["http://cdnjs.cloudflare.com/ajax/libs/gl-matrix/2.1.0/gl-matrix-min.js", "../webgl.js", "cloth.js"], main);
}
